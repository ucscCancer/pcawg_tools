...
#RUN     wget -O /opt/bin/MuSEv1.0rc http://odin.mdacc.tmc.edu/~yfan1/MuSE/MuSEv1.0rc
RUN     wget -O /opt/bin/MuSEv1.0rc http://odin.mdacc.tmc.edu/~yfan1/MuSE/MuSEv1.0rc_submission_b391201
